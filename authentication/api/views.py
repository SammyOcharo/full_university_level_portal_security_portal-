...
class SecurityLoginAPIView(APIView):
    ...
    serializer_class = SecurityLoginSerializer
...
class SecurityLoginApproveAPIView(APIView):
    ...
    def post(self, request):
        try:
            ...
            login_otp = SecurityLoginOtp.objects.filter(email=username)
...
class SecurityResendOtpAPIView(APIView):
    ...
    def post(self, request):
        try:
            ...
            last_otp = SecurityPasswordResetOtp.objects.filter(email=email).last()
